...
onMounted(() => {
  ...
  fetchAnualCiiData(curSelectedImoNumber, year.value)
})
...
const fetchAnualCiiData = async () => {
  getUsedFuelStatus()
  if (curSelectedShip.value != null || curSelectedShip.value != '') {
    curSelectedImoNumber = curSelectedShip.value.imoNumber
    await ciiStore.fetchAnualCiiData(curSelectedImoNumber, year.value)
  }
}
