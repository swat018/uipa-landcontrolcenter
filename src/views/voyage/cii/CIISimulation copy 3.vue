<template>
  ...
  <v-row no-gutters class="detail-page h-100" style="overflow : visible">
    ...
    <!-- 테이블  -->
    <v-sheet style="height : 100%; max-height: calc(100% - 40px - 24px); ">
      <v-sheet class="align-center mt-6 mb-6" style="height : 33%">
        <DxDataGrid id="cii-simulator-grid3" ref="ciiSimulatorGrid" class="h-100" :data-source="pastCiiData.first"
          ...
          <DxColumn data-field="distance" caption="Distance(nm)" alignment="center"
            header-cell-template="distance-header" :allow-editing="false" />
      ...
      <v-sheet class="mt-0 w-100 d-flex" style="height: calc(67% - 48px);">
        ...
        <v-sheet class="h-100 pa-6 ml-3 rounded-lg" style="width : 70%" color="#333334">
          <div class="cii-title mb-6" style="line-height : 1">CII 요약</div>
          <v-sheet class="d-flex flex-column" color="#333334" style="height: calc(100% - 24px );">
            <v-sheet class="flex-grow-1 mb-4" color="#333334">
              <div class="mb-2 cii-sub-title">현재 CII 지표 (2024-01-01 ~ 2024-04-29)</div>
              <v-sheet class="d-flex">
                <v-card class="grade-item d-flex justify-center mr-3">
                ...
                <v-card class="justify-center grade-item d-flex mx-3">
                  <template v-slot:prepend>
                ...
                <v-card class="grade-item d-flex justify-center ml-3">
                  <template v-slot:prepend>
            ...
            <v-divider></v-divider>
            <v-sheet color="#333334" class="d-flex flex-column flex-grow-1 mt-4">
              <div class="d-flex flex-grow-1 mb-2 cii-sub-title">총 CII 지표 (2024-01-01 ~ 2024-12-31)</div>
              <v-sheet class="d-flex">
