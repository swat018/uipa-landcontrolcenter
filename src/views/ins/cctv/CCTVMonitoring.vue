      ...
      <v-row class="h-100">
        <v-col cols="9">
          <v-sheet class="video-container cctvlist-grid">
            ...
            <video class="w-100" v-for="cctv in cctvList" controls controlslist="nodownload noplaybackrate"
        ...
        <v-col cols="3">
          <DxDataGrid id="cctvListGrid" ref="cctvListGrid" :data-source="cctvs" :show-column-headers="false"
            :show-column-lines="false" :show-borders="true" class="cctvlist-grid">
            <DxSelection mode="single"></DxSelection>
            <DxScrolling mode="virtual" />

            <DxColumn data-field="cctvName" class="cctv-name" :allow-editing="false" />

            <DxColumn data-field="status" :allow-editing="false" cell-template="cctv-status-template" width="15%" />
...
.cctvlist-grid {
  ...
  max-height: calc(100vh - 65px - 24px - 62px - 24px - 24px - 24px);
}
