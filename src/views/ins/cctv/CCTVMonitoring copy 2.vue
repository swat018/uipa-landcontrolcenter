<template>
  <v-sheet class="d-flex pt-4 ga-4">
    <div class="cctvs-container d-flex flex-wrap ga-4">
      <div class="cctv-container">
        <div class="video-container" v-for="cctv in cctvList">
    ...
    <div class="cctv-list-container d-flex flex-column">
      <DxDataGrid id="cctvGrid" ref="cctvGrid" :data-source="cctvs" :show-column-headers="false" class="cctv-grid">
