<template>
  <v-sheet class="d-flex flex-column pt-4 ga-4 w-100">
    <div class="d-flex ga-4" style="height: calc(100% * 0.8);">
      ...
      <div class="cctv-list-container d-flex flex-column">
        <DxDataGrid id="cctvGrid" ref="cctvGrid" class="h-100 video-grid" :data-source="cctvs" :show-column-headers="false">
