<template>
  <v-sheet class="h-100 py-6 detail-page">
    ...
    <v-sheet class="mt-6 pa-3 rounded-lg" color="#333334">
      <v-container fluid>
        <v-row>
          <v-col cols="5" xl="6" xxl="7">
            <Echart :option="option" class="tabs-filter-container"></Echart>
          </v-col>
          <v-col cols="7" xl="6" xxl="5">
            <DxDataGrid id="equimentGrid" ref="equimentGrid" class="tabs-filter-container" :show-borders="true"
              :data-source="alertHistoryDetail" key-expr="id" :selected-row-keys="selectedRowKeys"
              :column-auto-width="true">
              <DxSelection mode="multiple" show-check-boxes-mode="always"></DxSelection>
              <DxScrolling mode="virtual" />
              <!-- row-rendering-mode="virtual" -->
              <DxColumn data-field="equipmentNo" caption="Equip No" alignment="center" :allow-editing="false"
                width="20%" />
              <DxColumn data-field="tagId" catpion="Tag ID" alignment="center" :allow-editing="false" width="20%" />
