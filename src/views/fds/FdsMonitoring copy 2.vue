<template>
  ...
  <v-sheet class="test23 pa-4 rounded-lg d-flex flex-column detail-page">
    ...
    <div class="d-flex py-4" style="border : 1px solid #5F5F67; background : #000; height : calc(100vh / 3)">
