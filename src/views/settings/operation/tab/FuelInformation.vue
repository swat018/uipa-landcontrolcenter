<template>
  <v-card class="operation-info cardContainer rounded-lg my-4  h-100">
    <v-card-title>
      운항 가능 추정 거리 및 예상 연료 충전 비용
    </v-card-title>

    <v-card-text class="mx-4 pa-8">
      ...
      <div class="d-flex w-100 ">
        ...
        <div class="w-30">
          ...
          <v-text-field v-model="fuelInfo.perchargeableMgo" @input="calcCostMGO" variant="solo-filled" density="compact"
            bg-color="#434348" hide-details></v-text-field>
        </div>
        <div class="w-5 d-flex align-center justify-center">=</div>
        <div class="w-30">
          <div class="mb-1">운항 가능 추정 거리(NM)</div>
      ...
      <div class="d-flex w-100  mt-5 ">
        ...
        <div class="w-30">
          ...
          <v-text-field v-model="fuelInfo.perchargeableLng" @input="calcCostLNG" variant="solo-filled" density="compact"
            bg-color="#434348" hide-details></v-text-field>
        </div>
        <div class="w-5 d-flex align-center justify-center">=</div>
        <div class="w-30">
